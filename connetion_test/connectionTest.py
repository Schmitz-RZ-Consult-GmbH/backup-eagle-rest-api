#######################################################################################################
#
# Python Example - Connection test
# (C) Schmitz RZ Consult GmbH - BACKUP EAGLE
#
# Example usage: 
# python connectionTest.py --host="192.168.0.1" --user="admin" --password="admin"
#
...
def main():
    ...
    url = "https://" + options.host + ":10987/api/rest/connection-test"
