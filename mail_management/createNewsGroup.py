#######################################################################################################
#
# Python Example - Create newsgroup
# (C) Schmitz RZ Consult GmbH - BACKUP EAGLE
#
# Example usage:
# python createNewsGroup.py --host="192.168.0.1" --user="admin" --password="admin" --group='{\"name\":\"All_PDFs\",\"pattern\":\"*.pdf\",\"subject\":\"BACKUP_EAGLE_Reports\",\"text\":\"BACKUP_EAGLE_Reports\"}'
#
...
def main():
    ...
    url = "https://" + options.host + ":10987/api/rest/mail/newsgroup"
