#######################################################################################################
#
# Python Example - Query newsgroups
# (C) Schmitz RZ Consult GmbH - BACKUP EAGLE
#
# Example usage:
# python queryNewsGroups.py --host="192.168.0.1" --user="admin" --password="admin" --pretty-print=True --group-id="8"
#
...
parser.add_option("--group-id", dest="groupId", help="Query newsgroup with specific id (optional)")
