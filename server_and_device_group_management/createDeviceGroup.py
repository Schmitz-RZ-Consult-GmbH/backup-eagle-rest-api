#######################################################################################################
#
# Python Example - Create a device group
# (C) Schmitz RZ Consult GmbH - BACKUP EAGLE
#
# Example usage:
# python createDeviceGroup.py --host="192.168.0.1" --user="admin" --password="admin" --group='{\"name\":\"Test\",\"entries\":[{\"deviceTypePattern\":\"Device\"}]}'
#
...
def main():
    ...
    url = "https://" + options.host + ":10987/api/rest/group/device"
