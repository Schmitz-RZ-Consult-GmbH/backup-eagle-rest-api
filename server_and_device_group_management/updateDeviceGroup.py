#######################################################################################################
#
# Python Example - Update a device group
# (C) Schmitz RZ Consult GmbH - BACKUP EAGLE
#
# Example usage:
# python updateDeviceGroup.py --host="192.168.0.1" --user="admin" --password="admin" --group-id="2" --group='{\"name\":\"Test\",\"entries\":[{\"dataSourceClassPattern\":\"*\",\"versionPattern\":\"8.1*\""}]}'
#
...
parser.add_option("--group-id", dest="groupId", help="Id of the device group.")
parser.add_option("--group", dest="group", help="Name (required) and entries as json.")
...
def main():
    ...
    url = "https://" + options.host + ":10987/api/rest/group/device/" + options.groupId
