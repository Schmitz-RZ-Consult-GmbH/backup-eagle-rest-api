#######################################################################################################
#
# Python Example - Query user defined groups
# (C) Schmitz RZ Consult GmbH - BACKUP EAGLE
#
# Example usage:
# python queryUserDefinedGroups.py --host="192.168.0.1" --user="admin" --password="admin" --pretty-print=True
#
...
def main():
    ...
    url = "https://" + options.host + ":10987/api/rest/udgs/list"
