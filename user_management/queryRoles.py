#######################################################################################################
#
# Python Example - Query roles
# (C) Schmitz RZ Consult GmbH - BACKUP EAGLE
#
# Example usage:
# python queryRoles.py --host="192.168.0.1" --user="admin" --password="admin" --pretty-print=True
#
...
parser.add_option("--role-id", dest="roleId", help="Query role with specific id (optional)")
