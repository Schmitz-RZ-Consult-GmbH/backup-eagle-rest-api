#######################################################################################################
#
# Python Example - Query users
# (C) Schmitz RZ Consult GmbH - BACKUP EAGLE
#
# Example usage:
# python queryUsers.py --host="192.168.0.1" --user="admin" --password="admin" --pretty-print=True
#
...
parser.add_option("--user-id", dest="userId", help="Query user with specific id (optional)")
...
def main():
    ...
    url = "https://" + options.host + ":10987/api/rest/security/user"
