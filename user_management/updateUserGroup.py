#######################################################################################################
#
# Python Example - Update a user group
# (C) Schmitz RZ Consult GmbH - BACKUP EAGLE
#
# Example usage:
# python updateUserGroup.py --host="192.168.0.1" --user="admin" --password="admin" --group-id="2" --group='{\"name\":\"Admins\",\"description\":\"Administratoren\",\"directoryAlias\":\"admin\",\"roleIds\":[1,2]}'
#
...
parser.add_option("--group-id", dest="groupId", help="Id of the user group.")
parser.add_option("--group", dest="group", help="Name (required), description (required), directoryAlias (required) and roleIds as json.")
...
def main():
    ...
    url = "https://" + options.host + ":10987/api/rest/security/group/" + options.groupId
